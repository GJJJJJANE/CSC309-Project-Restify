# Generated by Django 4.1.7 on 2023-03-12 04:36
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('state', models.CharField(choices=[('pe', 'Pending'), ('de', 'Denied'), ('ex', 'Expired'), ('ap', 'Approved'), ('ca', 'Canceled'), ('te', 'Terminated'), ('co', 'Completed'), (None, 'Reservation status')], max_length=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('property', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='restifyapp.property')),
                ('reservation', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='restifyapp.reservation')),
            ],
        ),
    ]
