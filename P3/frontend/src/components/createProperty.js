...
const CreatePropertyForm = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        propertyData.append("amen_essential", "wifi"); //change
        propertyData.append("amen_indoor", "tv"); //change
        propertyData.append("amen_outdoor", "bbq"); //change
        ...
        try {
          const response = await axios.post("http://127.0.0.1:8000/create/", propertyData, {
            headers: {
                ...
                "Authorization": `Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ0b2tlbl90eXBlIjoiYWNjZXNzIiwiZXhwIjoxNjgxMTkwNDU1LCJpYXQiOjE2ODExOTAxNTUsImp0aSI6Ijk3Zjg5YjEzYjUxNDQ3OWViYWRlMjBmMDM0YThhN2YxIiwidXNlcl9pZCI6NX0.CGwD3WcPS-SPlUg575zhG2iYH9zTSCSElktUXQIzA6s`
            },
          });
